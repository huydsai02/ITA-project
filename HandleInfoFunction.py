...
if __name__ == '__main__':
  maze, cp1, cr, cb, score, optimal_path, len_of_best, highest_score, point_of_best, path_bot_go, main_path, op_road = AllNeedInfo(size = (7,7), num_point = 5, start = (1,1), end = (5,5), multi_path = False)
